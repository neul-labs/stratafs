...
import { GetStatus, StartStrataFS, StopStrataFS, GetConfig, Search, AddSource, RemoveSource, InitConfig, Quit, ShowWindow, GetMountStatus, MountFilesystem, UnmountFilesystem, OpenMountPoint } from '../wailsjs/go/main/App'
...
async function performSearch() {
  ...
  if (!isReady.value) {
    error.value = 'Start StrataFS first'
    return
  }
  loading.value = true
  error.value = ''
